...
SiceCAT.Control.WFSServiceStore = function(c) {
    c = c || {};
    GeoExt.data.WFSCapabilitiesStore.superclass.constructor.call(
        ...
        Ext.apply(c, {
            ...
            reader: new SiceCAT.Control.WFSServiceReader(
                c, c.fields
            )
        })
    );
};
Ext.extend(SiceCAT.Control.WFSServiceStore, GeoExt.data.WFSCapabilitiesStore);