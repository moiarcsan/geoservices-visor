 ...
 *      response.
 */
SiceCAT.Control.WFSCapabilitiesVectorReader = function(meta, recordType) {
    meta = meta || {};
    if(!meta.format) {
...
Ext.extend(SiceCAT.Control.WFSCapabilitiesVectorReader, GeoExt.data.WFSCapabilitiesReader, {
    ...
    readRecords: function(data) {
        ...
        var featureTypes = data.featureTypes[0].properties;
