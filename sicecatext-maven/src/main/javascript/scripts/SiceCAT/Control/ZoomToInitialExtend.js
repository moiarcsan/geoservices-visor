 ...
 *  - <OpenLayers.Control>
 */
OpenLayers.Control.ZoomToInitialExtend = OpenLayers.Class(OpenLayers.Control, {
     ...
     */
    trigger: function() {
        if (this.map && this.map.initialExtent) {
            this.map.zoomToExtent(this.map.initialExtent);
        }    
    },

    CLASS_NAME: "OpenLayers.Control.ZoomToInitial"
});
