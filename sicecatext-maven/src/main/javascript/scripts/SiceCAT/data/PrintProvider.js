 ...
 */
SiceCAT.data.PrintProvider = Ext.extend(Ext.util.Observable, {
     ...
     *  is not provided. This is the object returned by the ``info.json.do``
     *  endpoint of the print service, and is usually obtained by including a
     *  script tag pointing to
     *  http://path/to/printservice/info.json.do?var=myvar in the head of the
