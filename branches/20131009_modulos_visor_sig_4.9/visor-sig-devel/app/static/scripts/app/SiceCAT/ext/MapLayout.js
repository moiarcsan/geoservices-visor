		...
		.extend(
				Ext.Component,
				{
					...
					init_toolbarNav : function() {
						...
						this.toolbarNav.push(
							{
								xtype: "gx_sicecat_multisearchcombo",
								map: this.map,
								openlsUrl: openlsUrl
							});
						...
						this.toolbarNav.push(this.getSearchWFSAction(layers));
						...
						var panel = new SiceCAT.QueryPanel(
								{
									...
									listeners : {
										storeload : function(panel, store) {
											var axiliaryLayerWFS = AuxiliaryLayer
													.getLayer(sicecatInstance.nombreCapaResultadoText);
											...
											if (founds == 0) {
												statusBar
														.setText(searchWFSNotFoundStateText);
											} else {
												statusBar
														.setText(String
																.format(
