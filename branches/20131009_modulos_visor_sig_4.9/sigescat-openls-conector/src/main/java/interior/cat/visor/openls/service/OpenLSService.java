 ...
 * 
 */
public interface OpenLSService {

	/**
	 * Devuelve las conincidencias geolocalizadas para el punto pasado como argumento
	 * 
	 * @param position
	 * @param reverseGeocodePreference
	 * s
	 * @return resultado de conincidencias en el puntow
	 */
	public ReverseGeocodeResponseType reverseGeocode(PositionType position, List<ReverseGeocodePreferenceType> reverseGeocodePreference);
